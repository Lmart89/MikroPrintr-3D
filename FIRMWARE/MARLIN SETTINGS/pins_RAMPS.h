...
#ifndef Y_STOP_PIN
  #ifndef Y_MIN_PIN
    #define Y_MIN_PIN                         4  // Y-
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                         5  // Y+
  #endif
#endif
#ifndef Z_STOP_PIN
  #ifndef Z_MIN_PIN
...
#ifndef Z_STEP_PIN
  #define Z_STEP_PIN                          42 //reasignado para usar el pin 46 para control pwm de luces rgb.
#endif
#ifndef Z_DIR_PIN
  #define Z_DIR_PIN                           48
#endif
...
//
//ESTE CODIGO DEFINE EL PIN QUE SE USARA PARA CONTROLAR EL VENTILADOR DE LA PLACA USANDO UNA SEÑAL PWM POR SOFTWARE
// EN EL PIN 6 DE LA PLACA QUE ES UN PIN PWM.
#define SYSFAN_PIN 6 //PIN D6 DEL ARDUINO MEGA 2560 PRO.

/** LUCES RGB
 * IMPLEMENTACION DEL CONTROL DE LUCES RGB
 * LA BOARD POSEE INTEGRADO MOSFETS PARA CONTROLAR LUCES RGB,
 * UNO POR CADA CANAL DE COLOR.
 * UN PIN HEADER SE ENCARGA DE PROVEER LA CONEXION A LA TIRA RGB
 * EL DISEÑO ESTA IMPLEMENTADO PARA USAR UNA TIRA NO MUY GRANDE.
 * LA RAZON ES QUE SON LUCES INTERNAS EN LA CARCASA, 
 * POR LO QUE SOLO SE HACEN NECESIARIO HACER USO DE UNAS 4-6 LUCES RGB COMO MUCHO.
 * TENER EN CUENTA ESTO ANTES DE HACER ALGUNA MODIFICACION A LA DISPOSICION DE LAS LUCES.
 */

#define LED_R_PIN 44  //led Rojo
#define LED_G_PIN 45  // led Verde
#define LED_B_PIN 46  // led Azul

/**
 * sensor de filamento mecanico. configuration.h indica que hay que definirlo manualmente.
 * pin usado sera el D5. o 5 en la nomenclatura de arduino.
 * el pin es un pin digital, por lo que no se necesita un buffer.
 * el sensor de filamento es un switch que se cierra cuando el filamento no pasa por el.
 * el pin se conecta a GND y al pin D5.
 * el pin D5 se conecta a 5V.
 * el pin D5 se conecta a un resistor de 10k a GND.
 * el pin D5 se conecta a un capacitor de 10uF a GND.
 * el capacitor se conecta a 5V.
 * el capacitor se usa para filtrar el ruido de la señal.
 */
#define FIL_RUNOUT_PIN 5 //pin D5 del arduino mega 2560 pro.
