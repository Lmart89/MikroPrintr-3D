 ...
 */
#define CONFIGURATION_H_VERSION 01010000
...
#define STRING_CONFIG_H_AUTHOR "(LUIS E MTZ S, V1.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MikroPrinter 3D"
...
#define RGB_LED_BRIGHTNESS 255  // Ajusta entre 0 (apagado) y 255 (máxima intensidad)
#define RGB_LED_STARTUP_BRIGHTNESS 255 // Ajusta entre 0 (apagado) y 255 (máxima intensidad)
#define RGB_LED_STARTUP_TEST_BRIGHTNESS 255 // Ajusta entre 0 (apagado) y 255 (máxima intensidad)
#define RGB_LED_STARTUP_TEST_DURATION 3000 // (ms) Duration of the startup test
#define RGB_LED_STARTUP_TEST_COLOR { 255, 0, 0 } // RGB color for startup test
  ...
  #define RGB_LED_W_PIN -1 //no usar canal blanco.
#endif

#if ANY(RGB_LED, RGBW_LED, PCA9632)
  #define RGB_STARTUP_TEST              // For PWM pins, fade between all colors
  #if ENABLED(RGB_STARTUP_TEST)
    #define RGB_STARTUP_TEST_INNER_MS 100  // (ms) Reduce or increase fading speed
  #endif
#endif
