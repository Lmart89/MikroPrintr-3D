...
#define RGB_COLOR_PREHEAT 255, 128, 0   // Naranja: Precalentamiento
#define RGB_COLOR_PRINT   0, 255, 0     // Verde: Impresión activa
#define RGB_COLOR_COOLDOWN 0, 0, 255    // Azul: Enfriamiento
#define RGB_COLOR_ERROR    255, 0, 0    // Rojo: Error del sistema

#define RGB_COLOR_CHANGE_FEEDBACK
...
//CODIGO PARA LA AUTOEJECUCION DEL ABANICO DEL SISTEMA SYSFAN
#define FAN_PWM_FREQUENCY 250 
#define E0_AUTO_FAN_PIN SYSFAN_PIN  // Asigna el pin del ventilador automático al SYSFAN_PIN
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50  // Activa el ventilador si la temperatura supera los 50°C
#define EXTRUDER_AUTO_FAN_SPEED 255  // Velocidad máxima cuando el ventilador se encienda.
#define NUM_SERVOS 1
